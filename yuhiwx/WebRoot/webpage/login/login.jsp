...
<body>
                ...
                <form name="formLogin" id="formLogin" action="loginController.do?login" check="loginController.do?checkuser" method="post">
                    ...
                    <div class="tip">
                        ...
                        <div style="float: right; margin-left:-220px; margin-right: 25px;">
                            <img id="randCodeImage" src="randCodeImage.action" />
                        </div>
                    </div>
                    ...
                    <div class="loginButton">
                     ...
                     <div>
                        <div style="float: right; margin-left:-220px; margin-right: 40px;">
                           	 技术支持： <font color="red">元海智云</font>   &nbsp;&nbsp;&nbsp;    官网: <font color="red"><a href="http://www.yuhi.com.cn" target="_blank">www.yuhi.com.cn</a></font> 
                        </div>
                    </div>
                </form>
            </div>
    ...
    <div class="clear"></div>
    <div id="versionBar">
        <div class="copyright">&copy; 版权所有 <span class="tip"> (推荐使用IE8+,谷歌浏览器可以获得更快,更安全的页面响应速度) 技术支持: <font color="red">元海智云</font></span></div>
    </div>
    <!-- Link JScript-->
