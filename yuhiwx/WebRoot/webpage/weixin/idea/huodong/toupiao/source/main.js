...
$('.caidan i').live('touchstart',function(){
    //alert('ok')
    $('.txte').val($(this).html()).css('color','#333');
	$('.butn').find("i").addClass("hide");
	$('.caidan').slideUp()
});

$("body ul.relative li span").live("touchstart",function(){
    $("ul.relative li span").removeClass("on");
    $(this).addClass("on");
});
