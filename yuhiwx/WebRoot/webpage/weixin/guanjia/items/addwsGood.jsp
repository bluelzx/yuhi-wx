				...
				<div class="appmsg_content" id="js_appmsg_preview">
					<h4 class="appmsg_title">
						<a target="_blank" href="javascript:void(0);"
							onclick="return false;" id="imageTitle">标题信息</a>
					</h4>
			...
			<div class="appmsg_editor" style="margin-top: 0px;">
				<div class="inner">
					<t:formvalid formid="formobj" dialog="true" usePlugin="password"
						layout="table" action="weixinShopGoodsController.do?doAdd">
						...
						<table cellpadding="0" cellspacing="1" class="formtable">
							<tr>
								...
								<td class="value"><input class="inputxt" id="title"
									...
									value="${cmsArticlePage.title}" datatype="*"
									onblur="setimageTitle(this)"> <span
							...
							<tr>
								<td align="right"><label class="Validform_label">
										简单描述: </label></td>
								<td class="value"><input class="inputxt" id="title"
									name="simpleDescs" style="width: 300px"
									value="${cmsArticlePage.title}" datatype="*"
									onblur="setimageTitle(this)"> <span
									class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">简单描述</label></td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label">
										上传图片: </label></td>
								<td class="value"><span
									...
									nullmsg="请添加图片" value="${cmsArticlePage.imageHref}"> <span
							...
							<tr>
								<td align="right"><label class="Validform_label">
										所属分类: </label></td>
								<td class="value">
										<select name="wgTypeid">
											<c:forEach items="${parenttypes }" var="parents">
							...
							<select name="sellerId">
								<c:forEach items="${buieses }" var="buiese">
										<option value="${buiese[0]}">${buiese[1]}</option>
								</c:forEach>
							</select>
								<span class="Validform_checktip"></span>
								<label class="Validform_label" style="display: none;">所属商家</label>
							</td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label">
							...
							<tr>
								<td align="right"><label class="Validform_label">
										折扣: </label></td>
								<td class="value"><input class="inputxt" id="title"
									name="sale" style="width: 300px" value="10" datatype="*"
									onblur="setimageTitle(this)"> <span
									class="Validform_checktip"></span> <label
							...
							<tr>
								<td align="right"><label class="Validform_label">
										上架时间: </label></td>
								<td class="value"><input id="date" name="shelveTime"
									class="easyui-datebox datebox-f combo-f" comboname="date"
									style="display: none;"> <span class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">上架时间</label></td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label">
										下架时间: </label></td>
								<td class="value"><input id="date02" name="removeTime"
									class="easyui-datebox datebox-f combo-f" comboname="date"
									style="display: none;"> <span class="Validform_checktip"></span> <label
									class="Validform_label" style="display: none;">下架时间</label></td>
							</tr>
							<tr>
								<td align="right"><label class="Validform_label">
										商品详情: </label></td>
								<td class="value"><textarea name="descriptions" id="content"
										style="width: 350px;height:300px">${cmsArticlePage.content}</textarea>
									<script type="text/javascript">
