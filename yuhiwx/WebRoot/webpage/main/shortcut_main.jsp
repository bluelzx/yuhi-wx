...
<SCRIPT type="text/javascript">
	...
	$(function() {
		$('#layout_jeecg_onlineDatagrid').datagrid({
			url : '${webRoot}systemController.do?datagridOnline&field=ip,logindatetime,user.userName,',
			title : '',
			iconCls : '',
			fit : true,
			fitColumns : true,
...
<div region="north" border="false" title="" style="BACKGROUND: #A8D7E9; height: 100px; padding: 1px; overflow: hidden;">
	...
	<tr>
		<td align="left" style="vertical-align: text-bottom"><img src="${webRoot}plug-in/weixin/logo/logo_weixin2.png"> <!--
		...
		<table border="0" cellpadding="0" cellspacing="0">
			<tr style="height: 25px;" align="right">
				<td style="" colspan="2">
				<div style="background: url(${webRoot}plug-in/login/images/top_bg.jpg) no-repeat right center; float: right;">
				...
				<div id="layout_north_kzmbMenu" style="width: 100px; display: none;">
					<div onclick="openwindow('用户信息','${webRoot}userController.do?userinfo')">个人信息</div>
					<div class="menu-sep"></div>
					<div onclick="add('修改密码','${webRoot}userController.do?changepassword')">修改密码</div>
					<div class="menu-sep"></div>	
					<div onclick="add('修改首页风格','${webRoot}userController.do?changestyle')">首页风格</div>
				</div>
				<div id="layout_north_zxMenu" style="width: 100px; display: none;">
					<div onclick="exit('${webRoot}logout.do','确定退出该系统吗 ?','http://mt.yuhi.com.cn:10028/yuhi-sso/logout?service=${webRoot}login.do');">退出系统</div>
				</div>
				</div>
                <div style="float: left; margin-left: 8px;margin-right: 5px; margin-top: 5px;">
                    <img src="${webRoot}plug-in/easyui/themes/default/images/layout_button_up.gif"
...
<!-- 左侧-->
<div region="west" split="true" href="${webRoot}loginController.do?shortcut_top" title="导航菜单" style="width: 200px; padding: 1px;"></div>
<!-- 中间-->
<div id="mainPanle" region="center" style="overflow: hidden;">
<div id="maintabs" class="easyui-tabs" fit="true" border="false">
<div class="easyui-tab" title="首页" href="${webRoot}loginController.do?home" style="padding: 2px; overflow: hidden;"></div>
<c:if test="${map=='1'}">
...
<div align="center" style="color: #CC99FF; padding-top: 2px">&copy; 版权所有:<font color="red">元海智云</font> </span></div>
</div>
