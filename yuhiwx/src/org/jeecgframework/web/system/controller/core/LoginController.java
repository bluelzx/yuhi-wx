...
//        }
		...
		try{
			...
			if(principal!=null){
				...
				TSUser u=userService.get(TSUser.class, (String)attributes.get("userid"));
				if(u!=null){
	...
	public String getPrimaryMenu() {
        ...
        for (TSFunction function : primaryMenu) {
            if(function.getFunctionLevel() == 0){
            	 String webRoot=(String) ContextHolderUtils.getSession().getAttribute("webRoot");
                if("Online 开发".equals(function.getFunctionName())){

                    floor += " <li><img class='imag1' src='"+webRoot+"plug-in/login/images/online.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/online_up.png' style='display: none;' />" + " </li> ";
                }else if("统计查询".equals(function.getFunctionName())){

                    floor += " <li><img class='imag1' src='"+webRoot+"plug-in/login/images/guanli.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/guanli_up.png' style='display: none;' />" + " </li> ";
                }else if("系统管理".equals(function.getFunctionName())){

                    floor += " <li><img class='imag1' src='"+webRoot+"plug-in/login/images/xtgl.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/xtgl_up.png' style='display: none;' />" + " </li> ";
                }else if("常用示例".equals(function.getFunctionName())){

                    floor += " <li><img class='imag1' src='"+webRoot+"plug-in/login/images/cysl.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/cysl_up.png' style='display: none;' />" + " </li> ";
                }else if("系统监控".equals(function.getFunctionName())){

                    floor += " <li><img class='imag1' src='"+webRoot+"plug-in/login/images/xtjk.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/xtjk_up.png' style='display: none;' />" + " </li> ";
                }else{
                    //其他的为默认通用的图片模式
                    String s = "";
                    ...
                    floor += " <li style='position: relative;'><img class='imag1' src='"+webRoot+"plug-in/login/images/default.png' /> "
                            + " <img class='imag2' src='"+webRoot+"plug-in/login/images/default_up.png' style='display: none;' />"
                            + s +"</li> ";
                }
            }
        }
