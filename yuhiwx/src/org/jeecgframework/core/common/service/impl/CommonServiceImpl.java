...
public class CommonServiceImpl implements CommonService {
	...
	@Override
	public <T> List<T> findByQueryStringAndPage(String query, int row, int page) {
		return this.commonDao.findByQueryStringAndPage(query,row,page);
	}

	@Override
	public Long countByHql(String query) {
		return this.commonDao.countByHql(query);
	}
