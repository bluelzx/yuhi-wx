 ...
 */
@Entity
@Table(name = "project_server_type", schema = "")
@SuppressWarnings("serial")
public class ProjectServerTypeEntity implements java.io.Serializable {
	/**id*/
	...
	/**createTime*/
	@Excel(exportName="createTime")
	private java.util.Date createTime;
	/**服务名*/
	@Excel(exportName="服务名")
