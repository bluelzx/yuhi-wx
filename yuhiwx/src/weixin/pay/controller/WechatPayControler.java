...
import weixin.pay.util.Log;
import weixin.pay.util.PropertiesUtil;
import weixin.pay.util.SignatureUtils;
import weixin.pay.util.WechatOrderUtils;
...
public class WechatPayControler extends BaseControler {
    ...
    @RequestMapping("/checkPayDetail")
    @ResponseBody
    public Map<String, Object> CheckPayDetail(String orderid) throws Exception {
    	Map<String, Object> result = WechatOrderUtils.CheckPayDetail(orderid);
        return result;
    }
    ...
    public String jsOrder(String detail, String desc, String goodSn,String openId, String orderSn, String amount) throws Exception {
    	JSONObject result = WechatOrderUtils.createOrder(detail, desc, openId, "12.0.0.1", goodSn, orderSn, amount, "JSAPI");
