package weixin.guanjia.shop.goods.type.service.impl;
...
@Service("weixinMallCategoryService")
@Transactional
public class WeixinMallCategoryServiceImpl extends CommonServiceImpl implements WeixinMallCategoryServiceI {
 	...
 	public <T> void delete(T entity) {
 		super.delete(entity);
 		//执行删除操作配置的sql增强
		this.doDelSql((WeixinMallCategoryEntity)entity);
 	}
 	
 	public <T> Serializable save(T entity) {
 		Serializable t = super.save(entity);
 		//执行新增操作配置的sql增强
 		this.doAddSql((WeixinMallCategoryEntity)entity);
 		return t;
 	}
 	...
 	public <T> void saveOrUpdate(T entity) {
 		...
 		//执行更新操作配置的sql增强
 		this.doUpdateSql((WeixinMallCategoryEntity)entity);
 	}
	 ...
	 * @return
	 */
 	public String replaceVal(String sql,WeixinMallCategoryEntity t){
