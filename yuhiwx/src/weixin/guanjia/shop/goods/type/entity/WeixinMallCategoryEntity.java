package weixin.guanjia.shop.goods.type.entity;
 ...
 */
@Entity
@Table(name = "WEIXIN_MALL_CATEGORY", schema = "")
@SuppressWarnings("serial")
public class WeixinMallCategoryEntity implements java.io.Serializable {
	/**主键*/
