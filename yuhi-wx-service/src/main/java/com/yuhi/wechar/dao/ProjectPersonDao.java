...
public class ProjectPersonDao extends JdbcTemplatesDao {
	
	private static final String SQL_SELECT = "SELECT * FROM PROJECT_PERSON";
	private static final String SQL_SELECT_BYID = "SELECT * FROM PROJECT_PERSON WHERE ID = ?";
