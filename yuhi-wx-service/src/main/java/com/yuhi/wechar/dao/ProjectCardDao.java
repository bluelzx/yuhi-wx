...
* 表数据操作
*/
@Repository("projectCardDao")
public class ProjectCardDao extends JdbcTemplatesDao {
	
	private static final String SQL_SELECT = "SELECT * FROM PROJECT_CARD";
	private static final String SQL_SELECT_BYID = "SELECT * FROM PROJECT_CARD WHERE ID = ?";
