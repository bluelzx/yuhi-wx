...
*/
@Path("/projectServerTypeService")
@Consumes({MediaType.APPLICATION_JSON, MediaType.TEXT_XML})
@Produces({ContentType.APPLICATION_JSON_UTF_8, ContentType.TEXT_XML_UTF_8})
public interface ProjectServerTypeFacade {
	/**
	 * 删除实体
	 * @param id
	 * @return
	...
	/**********************自定义接口******************************/
	@GET
	List<JSONObject> getPageList(Integer rows,Integer page) throws Exception;
	@GET
	Long getCountbySql(String[] args);
	/**
	 * 数据视图集合
	 */
	@POST
